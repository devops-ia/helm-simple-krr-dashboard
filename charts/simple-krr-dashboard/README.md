...
| job | object | `{"affinity":{},"annotations":{},"args":[],"backoffLimit":6,"backoffLimitPerIndex":6,"command":["/bin/bash","-c"],"completionMode":"Indexed","completions":1,"concurrencyPolicy":"Forbid","enabled":true,"env":{},"envFromSecrets":{},"failedJobsHistoryLimit":1,"image":{"pullPolicy":"IfNotPresent","repository":"us-central1-docker.pkg.dev/genuine-flight-317411/devel/krr","tag":"v1.23.0"},"kubectlVersion":"stable","labels":{},"maxFailedIndexes":null,"nodeSelector":{},"parallelism":1,"podAnnotations":{},"podLabels":{},"resources":{},"restartPolicy":"Never","schedule":"0 0 * * *","successfulJobsHistoryLimit":3,"terminationGracePeriodSeconds":30,"tolerations":[],"volumeMounts":[],"volumes":[]}` | CronJob configuration </br> Ref: https://kubernetes.io/docs/concepts/workloads/controllers/cron-jobs/ |
...
| job.backoffLimit | int | `6` | Number of retries before marking job as failed |
| job.backoffLimitPerIndex | int | `6` | Number of retries per index before marking job as failed |
...
| job.env | object | `{}` | Environment variables for the job |
| job.envFromSecrets | object | `{}` | Environment variables from secrets |
| job.failedJobsHistoryLimit | int | `1` | Number of failed jobs to keep |
| job.image | object | `{"pullPolicy":"IfNotPresent","repository":"us-central1-docker.pkg.dev/genuine-flight-317411/devel/krr","tag":"v1.23.0"}` | Image configuration for the job |
...
| job.maxFailedIndexes | string | `nil` | Maximum number of failed indexes |
...
| job.successfulJobsHistoryLimit | int | `3` | Number of successful jobs to keep |
...
| service | object | `{"port":8501,"type":"ClusterIP"}` | Kubernetes service to expose Pod </br> Ref: https://kubernetes.io/docs/concepts/services-networking/service/ |
| service.port | int | `8501` | Kubernetes Service port |
